...
public class UIController {
    ...
    @FXML // fx:id="popupMenu"
    private ContextMenu popupMenu; // Value injected by FXMLLoader

    @FXML // fx:id="popupMenuCreate"
    private MenuItem popupMenuCreate; // Value injected by FXMLLoader
    ...
    void initialize() {
        ...
        assert popupMenu != null : "fx:id=\"popupMenu\" was not injected: check your FXML file 'ui.fxml'.";
        assert popupMenuCreate != null : "fx:id=\"popupMenuCreate\" was not injected: check your FXML file 'ui.fxml'.";
        ...
        TreeItem<String> item1 = new TreeItem<>("dir");
        TreeItem<String> item2 = new TreeItem<>("abc");
